...
__all__ = ["ModerateAnalyzeImageResponse", "Author", "AuthorBlock", "AuthorTrustLevel", "Label", "Request"]
...
class Label(BaseModel):
    label: Literal[
        "nudity", "suggestive", "gore", "hate", "violence", "weapon", "smoking", "drugs", "alcohol", "text", "toxic"
    ]
...
class ModerateAnalyzeImageResponse(BaseModel):
