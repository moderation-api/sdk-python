...
class TestModerationAPI:
    ...
    def test_hardcoded_query_params_in_url(self, client: ModerationAPI) -> None:
...
class TestAsyncModerationAPI:
    ...
    async def test_hardcoded_query_params_in_url(self, async_client: AsyncModerationAPI) -> None:
